...
baguette_flamethrower:
  name: "法棍火焰噴射器"
  lore: |-
    <arrow> 使用法棍的力量點燃你所注視的實體
    <arrow> <insn>右鍵點擊</insn> 點燃你所注視的實體
    <arrow> <attr>燃燒時間：</attr> %burn-time%
```
...
item:
  baguette_of_wisdom:
    ...
    lore: |-
      <arrow> 使用法棍的力量來轉移經驗值
      <arrow> <insn>右鍵點擊</insn> 以經驗值充能
      <arrow> <insn>按住 Shift + 右鍵點擊</insn> 釋放儲存的經驗值
      <arrow> <attr>經驗值容量：</attr> %xp_capacity%
      <arrow> <attr>已儲存的經驗值：</attr> %stored_xp%
```
